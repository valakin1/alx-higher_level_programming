...
Solution: 1-safe_print_integer.py
...
OBOBOB12345
nb_print: 5
OBOBOB12345Traceback (most recent call last):
  File "./2-main.py", line 14, in <module>
OBOBOB    nb_print = safe_print_list_integers(my_list, len(my_list) + 2)
...
You are not allowed to import any module
Solution: 3-safe_print_division.py
...
$ amonkeyprogrammer@ubuntu:~/0x05$ 
Raise exception
OBOBOBWrite a function that raises a type exception.

OBOBOBPrototype: def raise_exception():
You are not allowed to import any module
OBOBOBSolution: 5-raise_exception.py

OBOBOB$ amonkeyprogrammer@ubuntu:~/0x05$ cat 5-main.py
#!/usr/bin/python3
...
You are not allowed to import any module
Solution: 6-raise_exception_msg.py
...
You have to use "{:d}".format() to print as integer
You are not allowed to use type()
Solution: 100-safe_print_integer_err.py
